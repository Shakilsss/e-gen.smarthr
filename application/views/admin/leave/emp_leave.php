...
<?php
    ...
    <div id="customModal">
        ...
        <?php echo form_open('admin/leave/add_leave', $attributes, $hidden);?>
        <input type="hidden" name="company_id" id="company_id" value="<?php echo $unit_id; ?>" />
        ...
        <div class="modal-content">
            ...
            <div class="col-md-12 timediv" style="padding: 0;">
                <div class="col-md-4" style="padding: 0;">
                    <div class="input">
                        <div class="level">Select Leave Type <span style="color:red">*</span></div>
                        <div class="pseudo6">
                ...
                <div class="col-md-3" style="padding: 0;">
                    <div class="input">
                        <div class="level">Select Start Date <span style="color:red">*</span></div>
                        <div class="pseudo6">
                            <input name="start_date" value="<?= date('Y-m-d') ?>" class="col-md-12" required style="width: 98%;border: none;cursor: pointer;" type="date" id="start_date" >
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group texta">
                    <label for="summary"> Leave Reason <span style="color:red">*</span> </label>
                    <textarea class="form-control" placeholder="Describe your leave reason" name="remarks" cols="30" rows="5" id="remarks" required></textarea>
                </div>
            </div>
    ...
    <div class="col-md-12 medelbar">
        <div class="col-md-10"
            ...
            Are you want to take a leave? Please make sure to leave the request form to HR/ Admin.
        </div>
