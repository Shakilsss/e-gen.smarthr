  ...
  <body>
    ...
    <div class="massage_content">
      ...
      <div class="bottom_massage">
        ...
        <strong class="unbold">
          I am requesting that the following leave be granted. I will report for work on
          <span class="namefiled bold"> <?php echo $result->from_date; ?> </span>
          I will hand over my duties and responsibilities to
          <span class="namefiled bold">....................................</span>
          For the duration of my leave period my contact details would be
          <span class="namefiled bold"><?php echo $result->contact_no; ?></span>
        </strong>
      </div>
    </div>
