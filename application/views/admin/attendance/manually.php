...
<button id="back_report" class="btn btn-sm btn-primary col-6" style="float:right;padding: 6px 10px !important;">Back
    Report</button>
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        <li class="nav-item active">
            <a class="nav-link active" id="insert-tab" data-toggle="tab" href="#insert" role="tab"
                aria-controls="insert" aria-selected="true">Insert</a>
        </li>
        <li class="nav-item">
          ...
          < ?php }?>
            ...
            <div class="row">
                ...
                <p style="padding: 0px 15px;" id="checked_value">
                    <span style="padding: 0px 20px"><label>Punch Miss</label> <input checked type="radio"
                            name="check_value" value="0"></span>
                ...
                <div class="col-md-12">
                    <div class="form-group col-lg-3">
                        <label>In Time</label>
                        <input type="text" name="in_time" id="in_time" class="form-control timepicker clear-1"
                            placeholder="HH:MM">
                    </div>
                    <div class="form-group col-lg-3">
                        <label>Out Time</label>
                        <input type="text" name="out_time" id="out_time" class="form-control timepicker clear-1"
                            placeholder="HH:MM">
                    </div>
                </div>
                <div class="col-md-12" id="extra_field">
                    <div class="form-group col-lg-6">
                        ...
                        <input type="text" name="project_name" id="project_name" class="form-control  clear-1"
                            placeholder="">
                    </div>
                    <div class="form-group col-lg-6">
                        <label>Contact Person</label>
                        <input type="text" name="contact_person" id="contact_person" class="form-control  clear-1"
                            placeholder="">
                    </div>
                ...
                <div class="col-lg-12">
                    <span onclick="manual_entry_ajax(event)" class="btn btn-sm btn-success"
                        style="float: right;margin-right: 15px;">Entry</span>
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="delete" role="tabpanel" aria-labelledby="delete-tab">
            ...
            <div class="form-group col-lg-6">
                <button type="submit" class="btn btn-sm btn-success"
                    style="padding: 6px 10px !important;margin-right:16px;margin-top:5px">Weekend Delete</button>
            </div>

            <div class="form-group col-lg-6">
                <button type="submit" class="btn btn-sm btn-success"
                    style="padding: 6px 10px !important;margin-right:16px;margin-top:5px">Holiday Delete</button>
            </div>
