    ...
    <div class="col-md-12">
        ...
        <div class="box <?php echo $get_animate;?>">
            <div class="box-header  with-border">
                <h3 class="box-title">Leave Type Edit</h3>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input required class="form-control" value="<?php echo isset($row->name) ? $row->name : '';?>" name="name" >
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label> Leave Amount <i class="hrsale-asterisk"><span style="color:red">*</span></i></label>
                                <input required class="form-control" value="<?php echo isset($row->balance) ? $row->balance : '';?>"
                                    name="balance" >
                            </div>
                        </div>
